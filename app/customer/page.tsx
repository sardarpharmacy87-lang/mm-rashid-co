    ...
    <main className="portal-main">
      <div className="portal-title-row">
        <div>
          ...
          <p>Track every enquiry, price and order from one secure place.</p>
        </div>
      ...
      <section className="summary-grid" aria-label="Account summary">
        ...
        <article><strong>{quotations.filter((item) => item.status === "sent").length}</strong><span>Prices awaiting decision</span></article>
      ...
      <section className="portal-section">
        <div className="portal-section-head"><h2>Enquiries and prices</h2><Link href="/customer/enquiries/new">New enquiry</Link></div>
        {enquiries.length ? (
