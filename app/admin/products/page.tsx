  ...
  return (
    <main className="portal-main">
      ...
      <section className="summary-grid">
        ...
        <article><strong>{products.filter((product) => product.active).length}</strong><span>Live</span></article>
      </section>
      ...
      <section className="portal-section">
        ...
        <div className="portal-table-wrap">
          <table className="portal-table">
            <thead><tr><th>Product</th><th>Pricing</th><th>Status</th><th>Visibility</th><th /></tr></thead>
            <tbody>
